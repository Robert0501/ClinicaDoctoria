...
public class Email {
	...
	public static void sendMail(String recepient) {
		...
		String myPassowrd = "vmnhzrrqdjsixsia";
		...
		try {
			...
			case 6:
				...
				break;
			case 7:
				Message doctorEmailSent = patientEmailSent(session, myAccountEmail, recepient,
						DoctorEmailSenderView.emailSubjectIn.getText(), DoctorEmailSenderView.email.getText());
				Transport.send(doctorEmailSent);
				break;
			}
